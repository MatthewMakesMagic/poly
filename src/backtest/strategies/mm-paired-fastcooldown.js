/**
 * Paired MM: Fast Cooldown (3s)
 *
 * Same as mm-paired-polyref but with cooldownMs=3000 (3s instead of 10s).
 * More frequent small buys for better price averaging.
 *
 * S = polyRef.price
 * Vol estimated from CL history (settlement oracle).
 */

export const name = 'mm-paired-fastcooldown';
export const description = 'Paired MM: PolyRef BS + hedging with 3s cooldown for more frequent entries.';
