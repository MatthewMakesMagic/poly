/**
 * Paired MM: Chainlink BS with Position-Aware Hedging
 *
 * Same as mm-paired-polyref but uses S=chainlink.price for BS computation
 * instead of polyRef.price. This prices the binary option directly from
 * the settlement oracle.
 */

export const name = 'mm-paired-bs';
export const description = 'Paired MM: Chainlink BS + position-aware hedging.';
