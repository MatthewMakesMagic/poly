/**
 * Paired MM: Exchange Median with Position-Aware Hedging
 *
 * Same as mm-paired-polyref but uses S=state.getExchangeMedian() for BS
 * computation. Skips if exchange median is unavailable.
 */

export const name = 'mm-paired-exchange';
export const description = 'Paired MM: Exchange Median BS + position-aware hedging.';
