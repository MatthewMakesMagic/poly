/**
 * Paired MM: No Cooldown
 *
 * Same as mm-paired-polyref but with cooldownMs=0 and capitalPerEntry=1.
 * Maximum frequency, smaller bets. Trades every tick if edge exists.
 *
 * S = polyRef.price
 * Vol estimated from CL history (settlement oracle).
 */

export const name = 'mm-paired-nocooldown';
export const description = 'Paired MM: PolyRef BS + hedging with zero cooldown and $1 bets for maximum frequency.';
