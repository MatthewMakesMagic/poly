/**
 * Paired MM: 3 Minute Entry Window
 *
 * Same as mm-paired-polyref but with entryWindowMs=180000 (3 min).
 * Concentrated activity near resolution. Tighter spreads expected.
 *
 * S = polyRef.price
 * Vol estimated from CL history (settlement oracle).
 */

export const name = 'mm-paired-3min';
export const description = 'Paired MM: PolyRef BS + hedging with 3 min entry window for concentrated near-close activity.';
