/**
 * Balanced Wide MM: Simultaneous Both-Side Buying with Loose Edge
 *
 * Same as mm-balanced-polyref but with a much looser minEdge default (0.005).
 * More trades, smaller guaranteed spread per pair.
 *
...
export const name = 'mm-balanced-wide';
export const description = 'Balanced Wide MM: buy both sides simultaneously with loose 0.5% min edge.';
  ...
  return [
    {
      ...
      reason: `balanced_wide: UP, askUp=${askUp.toFixed(3)}, askDn=${askDown.toFixed(3)}, spread=${spread}`,
    },
    {
      action: 'buy',
      token: `${sym}-down`,
      capitalPerTrade: capitalPerEntry,
      reason: `balanced_wide: DOWN, askUp=${askUp.toFixed(3)}, askDn=${askDown.toFixed(3)}, spread=${spread}`,
    },
  ];
}
