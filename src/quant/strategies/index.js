...
export function createAllQuantStrategies(capital = 100) {
    return [
        // ═══════════════════════════════════════════════════════════════════════
        // TP/SL TEST STRATEGY - For validating take profit and stop loss
        // Entry: 40-60% markets (near 50/50), $2 size, tight stops
        // SUCCESS: 10 trades with correct TP/SL behavior
        // ═══════════════════════════════════════════════════════════════════════
        createTP_SL_TestStrategy(capital),

        // ═══════════════════════════════════════════════════════════════════════
        // EXECUTION TEST - Verify trading system works end-to-end
        // Makes 5 x $1 trades on BTC, 30 seconds apart, following spot direction
        // ═══════════════════════════════════════════════════════════════════════
        createExecutionTest(capital),
