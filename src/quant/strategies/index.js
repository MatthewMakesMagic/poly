...
export function createAllQuantStrategies(capital = 100) {
    return [
        ...
        // ═══════════════════════════════════════════════════════════════════════
        // MICROLAG CONVERGENCE STRATEGIES (Jan 2026) - Expected profit model
        // Uses proven micro-lag thresholds (0.0002) + convergence-based entry
        // All exits via trailing stop (10% activation, 25% from peak)
        // ═══════════════════════════════════════════════════════════════════════
        createMicroLagConvergence(capital),       // Base: 5% expected profit, 10% trail activation
        createMicroLagConvergenceAggro(capital),  // Aggressive: 3% expected profit, 8% trail activation
        createMicroLagConvergenceSafe(capital),   // Safe: 8% expected profit, 12% trail activation
